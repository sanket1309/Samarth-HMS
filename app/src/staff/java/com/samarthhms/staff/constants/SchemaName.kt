package com.samarthhms.staff.constants
...
object SchemaName {
    ...
    const val STORED_STATE_DATABASE = "staff_stored_state_database"
    const val STORED_STATE_TABLE = "staff_stored_state_table"
    const val STORED_STATE_KEY = "stored_state_key"
    const val ADMIN_STATE_TABLE = "staff_admin_state_table"
    const val ADMIN_STATE_KEY = "admin_state_key"
    const val SWITCH_ADMIN_STATE_KEY = "switch_admin_state_key"
    const val STAFF_STATE_TABLE = "staff_staff_state_table"
